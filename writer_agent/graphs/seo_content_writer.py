...
class AutomatedSEOContentWriterGraph:
    def __init__(self,
        ...
        self.user_config = UserConfig.model_validate(user_config) if isinstance(user_config, dict) else user_config
        self.config = config
        self.article = None
        self.retriever = None
    ...
    async def create_initial_outline(self, state: ArticleState):
        ...
        logger.info("Creating initial outline...")
        ...
        logger.info("Initial outline created.")
        pprint(initial_outline.as_str)
    ...
    async def initialize_research(self, state: ArticleState):
        ...
        for raw_doc in raw_docs:
            try:
                ...
                logger.error(f"Error at eval(): {e}")
                continue
    ...
    async def refine_outline(self, state: ArticleState):
        ...
        logger.info("Outline refined.")
        pprint(updated_outline.as_str)
    ...
    async def write_description(self, state: ArticleState):
        ...
        logger.info("Writing meta description...")
    ...
    async def write_sections(self, state: ArticleState):
        ...
        pprint([section.section_title for section in sections])
    ...
    async def write_article(self, state: ArticleState):
        ...
        logger.info("Article is now available. System is done.")
